...
#ifndef PN_OPENSSL_FACTORIES_H
#define PN_OPENSSL_FACTORIES_H
...
/**
 * @brief Create an OpenSSL-backed ACRH (AES-256-CBC) cryptor.
 *
...
/**
 * @brief Create an OpenSSL-backed legacy cryptor.
 *
 * @param cipher_key    NUL-terminated cipher key string.
...
/**
 * @brief Destroy an OpenSSL-backed cryptor instance.
 *
 * Securely zeros key material before freeing. NULL-safe.
 *
