...
static const uint8_t k_ok_body[] =
    "{\"status\":200,\"message\":\"OK\",\"occupancy\":0,\"uuids\":[]}";
...
static void here_now_should_use_context_timeout_when_opts_timeout_is_zero(void** state)
{
    (void)state;
    reset_chain();
...
static void
here_now_should_use_per_request_timeout_when_opts_timeout_is_nonzero(void** state)
{
    (void)state;
    reset_chain();
...
static void where_now_should_use_context_timeout_when_opts_timeout_is_zero(void** state)
{
    (void)state;
    reset_chain();
...
static void
where_now_should_use_per_request_timeout_when_opts_timeout_is_nonzero(void** state)
{
    (void)state;
    reset_chain();
...
static void set_state_should_use_context_timeout_when_opts_timeout_is_zero(void** state)
{
    (void)state;
    reset_chain();
...
static void
set_state_should_use_per_request_timeout_when_opts_timeout_is_nonzero(void** state)
{
    (void)state;
    reset_chain();
...
static void get_state_should_use_context_timeout_when_opts_timeout_is_zero(void** state)
{
    (void)state;
    reset_chain();
...
static void
get_state_should_use_per_request_timeout_when_opts_timeout_is_nonzero(void** state)
{
    (void)state;
    reset_chain();
...
#if !PUBNUB_CFG_NO_HEAP
        cmocka_unit_test(here_now_should_use_context_timeout_when_opts_timeout_is_zero),
        cmocka_unit_test(
            here_now_should_use_per_request_timeout_when_opts_timeout_is_nonzero),
        cmocka_unit_test(
            where_now_should_use_context_timeout_when_opts_timeout_is_zero),
        cmocka_unit_test(
            where_now_should_use_per_request_timeout_when_opts_timeout_is_nonzero),
        cmocka_unit_test(
            set_state_should_use_context_timeout_when_opts_timeout_is_zero),
        cmocka_unit_test(
            set_state_should_use_per_request_timeout_when_opts_timeout_is_nonzero),
        cmocka_unit_test(
            get_state_should_use_context_timeout_when_opts_timeout_is_zero),
        cmocka_unit_test(
            get_state_should_use_per_request_timeout_when_opts_timeout_is_nonzero),
#else
