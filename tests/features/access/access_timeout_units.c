...
static void grant_token_should_use_context_timeout_when_opts_timeout_is_zero(void** state)
{
    (void)state;
    reset_chain();
    ...
    pubnub_grant_token_opts_t opts = {
        .ttl           = 5,
        .channels      = &s_ch_perm,
        .channel_count = 1,
        .timeout_ms    = 0,
...
static void
grant_token_should_use_per_request_timeout_when_opts_timeout_is_nonzero(void** state)
{
    (void)state;
    reset_chain();
...
#if !PUBNUB_CFG_NO_HEAP
        cmocka_unit_test(
            grant_token_should_use_context_timeout_when_opts_timeout_is_zero),
        cmocka_unit_test(
            grant_token_should_use_per_request_timeout_when_opts_timeout_is_nonzero),
#else
