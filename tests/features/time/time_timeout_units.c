...
static const uint8_t k_ok_body[] = "[17000000000000000]";
...
static void time_should_use_context_timeout(void** state)
{
    (void)state;
    reset_chain();
...
#if !PUBNUB_CFG_NO_HEAP
        cmocka_unit_test(time_should_use_context_timeout),
#else
